...
public class three_three {
    ...
    public static void main(String[] args) {
        ...
        try {
            File myObj = new File("C:\\Users\\User\\IdeaProjects\\JavaWorks\\input_3.3.txt");
        ...
        try {
            File myObj = new File("result_3.3.txt");
        ...
        try {
            FileWriter myWriter = new FileWriter("result_3.3.txt");
